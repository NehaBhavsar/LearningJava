    ...
    if(e){
        ...
        if(d[0].rows.length)try{
            ...
            if(F<e&&s<=0&&(c.lastpage===undefined||parseInt((F+i+n-1)/n,10)<=c.lastpage)){
                ...
                if(y)if(!(c.lastpage&&t>c.lastpage||c.lastpage==1||t===c.page&&t===c.lastpage))if(g.hDiv.loading)g.timer=setTimeout(g.populateVisible,c.scrollTimeout);
                else{
                c.page=t;
                if(x){
...
b("#first"+d+", #prev"+d+", #next"+d+", #last"+d,"#"+e).click(function(){
    ...
    else if(w>1&&x>=1)if(x===1)M=Q=false;
        else{
...
var Ca=function(e,d,i,n){
    ...
    for(d=i[0]=i[1]=i[2]=0;d<=e;d++)if(a.p.colModel[d].hidden===false)i[0]+=a.p.colModel[d].width+n;if(a.p.direction=="rtl")i[0]=a.p.width-i[0];
...
b(a).before(g.hDiv).click(function(e){
    ...
    if(i===true){
        if(a.p.cellEdit===true)if(a.p.multiselect&&d)b(a).jqGrid("setSelection",R[0].id,true);
            else{
            ka=R[0].rowIndex;
        ...
        }else if(a.p.multikey)if(e[a.p.multikey])b(a).jqGrid("setSelection",R[0].id,true);
        else{
...
a.updatepager=function(e,d){
    ...
    if(y){
        ...
        if(a.p.pginput===true){
            ...
            if(a.p.viewrecords)if(a.p.reccount===0)b(".ui-paging-info",y).html(a.p.emptyrecords);
            else{
            A=p+1;
            F=a.p.records;
            if(b.fmatter){
...
setSelection:function(f,j){
    return this.each(function(){
        function h(a){
            ...
            else if(z<r+v)if(z<v)b(c.grid.bDiv)[0].scrollTop=z
                }
                var c=this,g,k,l;
        if(f!==undefined){
...
setRowData:function(f,j,h){
    ...
    this.each(function(){
        ...
        if(l.p.datatype=="local"){
            var E=l.p._index[f];
            if(l.p.treeGrid)for(var P in l.p.treeReader)z.hasOwnProperty(l.p.treeReader[P])&&delete z[l.p.treeReader[P]];if(typeof E!="undefined")l.p.data[E]=b.extend(true,l.p.data[E],z);
            z=null
            }
        }catch(K){
        g=false
...
footerData:function(f,j,h){
    function c(r){
        for(var v in r)if(r.hasOwnProperty(v))return false;return true
        }
        var g,k=false,l={},
    a;
...
DateFormat:function(a,c,d,e){
    ...
    var l=i.getSeconds(),o=i.getMilliseconds(),n=i.getDay(),p=i.getFullYear(),q=(n+6)%7+1,s=(new Date(p,g-1,h)-new Date(p,0,1))/864E5,t={
    d:f(h),
    D:k.i18n.dayNames[n],
    j:h,
    ...
    function q(g,k,v,r){
        ...
        a(k.p.colModel).each(function(U){
            ...
            if(E!=="cb"&&E!=="subgrid"&&this.editable===true&&E!=="rn"){
                if(M===false)B="";
                else if(E==k.p.ExpandColumn&&k.p.treeGrid===true)B=a("td:eq("+U+")",k.rows[M]).text();else try{
                    ...
                    rowabove:false,
                    rowcontent:""
                },this.formoptions||{}),ea=parseInt(Z.rowpos,10)||K+1,ga=parseInt((parseInt(Z.colpos,10)||1)*2,10);
...
if(!v.url&&!c.useDataProxy)if(a.isFunction(e.p.dataProxy))c.useDataProxy=true;
    else{
    k[0]=false;
...
function p(){
    ...
    var e=this;
if(e.grid&&d){
    var u=e.p.id,o="FrmGrid_"+u,f="TblGrid_"+u,j={
        themodal:"editmod"+u,
        modalhead:"edithd"+u,
        modalcontent:"editcnt"+u,
        scrollelm:o
    },G=a.isFunction(c.beforeShowForm)?c.beforeShowForm:false,L=a.isFunction(c.afterShowForm)?c.afterShowForm:false,I=a.isFunction(c.beforeInitData)?c.beforeInitData:false,T=a.isFunction(c.onInitializeForm)?c.onInitializeForm:false,H=true,m=1,x=0,h,P,O,V;
    if(d===
        "new"){
        d="_empty";
            ...
            a(x.p.colModel).each(function(K){
                ...
                if(O!=="cb"&&O!=="subgrid"&&O!=="rn"&&A){
                    ...
                    var B=a.extend({},{
                        rowabove:false,
                        rowcontent:""
                    },this.formoptions||{}),N=parseInt(B.rowpos,10)||J+1,F=parseInt((parseInt(B.colpos,10)||1)*2,10);
                    if(B.rowabove){
...
if(w.grid&&d){
    ...
    var n=w.p.id,s="ViewGrid_"+n,t="ViewTbl_"+n,p={
        themodal:"viewmod"+n,
        modalhead:"viewhd"+n,
        modalcontent:"viewcnt"+n,
        scrollelm:s
    },e=a.isFunction(b.beforeInitData)?b.beforeInitData:false,u=true,o=1,f=0;
...
delGridRow:function(d,b){
    ...
    return this.each(function(){
        var l=this;
        if(l.grid)if(d){
            var q=typeof b.beforeShowForm==="function"?true:false,C=typeof b.afterShowForm==="function"?true:false,z=a.isFunction(b.beforeInitData)?b.beforeInitData:false,D=l.p.id,w={},n=true,s="DelTbl_"+D,t,p,e,u,o={
                themodal:"delmod"+D,
                modalhead:"delhd"+D,
            ...
            if(a("#"+o.themodal).html()!==null){
                ...
                a("#dData","#"+s+"_2").click(function(){
                                ...
                                if(j[0]===false){
                                    ...
                                    if(c.reloadAfterSubmit&&l.p.datatype!="local")a(l).trigger("reloadGrid");
                                        ...
                                        if(l.p.treeGrid===true)try{
                                            ...
                                            }catch(m){}else for(var x=0;x<H.length;x++)a(l).jqGrid("delRowData",H[x]);
                                        l.p.selrow=null;
                                        l.p.selarrrow=[]
                                        }
                    ...
                    if(!L.url&&!c.useDataProxy)if(a.isFunction(l.p.dataProxy))c.useDataProxy=true;
                        else{
                        j[0]=false;
...
saveRow:function(e,x,l,r,t,y,u){
    var j={
        ...
        restoreAfterErorr:true
    },s=a.makeArray(arguments).slice(1),f;
            ...
            if(k!==undefined){
                ...
                if(this.p.treeGridModel==="nested"){
                    ...
                    if(c.length)for(f in c)c[f][a]=parseInt(c[f][a],
                        10)-h;c=d.jgrid.from(this.p.data).greater(e,g,{
                        stype:"integer"
                    }).select();
...
addChildNode:function(b,c,a){
    ...
    if(e.p.treeGridModel==="nested"){
        ...
        if(c!==null){
            ...
            if(f.length)for(q in f)f[q][i]=parseInt(f[q][i],10)+2;f=d.jgrid.from(e.p.data).greater(j,h,{
                stype:"integer"
            }).select();
            if(f.length)for(q in f)f[q][j]=parseInt(f[q][j],10)+2;a[i]=h+1;
            a[j]=h+2
            }
        }
        ...
        return this.each(function(){
            var d=this,c=function(f,g){
                ...
                if(xmlJsonClass.xml2json&&b.jgrid.parse){
                    ...
                    e=b.jgrid.parse(e);
                    for(var l in e)if(e.hasOwnProperty(l))i=e[l];if(h){
                        h=e.grid.datatype;
    ...
    json2xml:function(a,b){
        var g=function(d,c,i){
            ...
            for(j in d)if(d.hasOwnProperty(j))if(j.charAt(0)===
                "@")h+=" "+j.substr(1)+'="'+d[j].toString()+'"';else k=true;h+=k?">":"/>";
            if(k){
                for(j in d)if(d.hasOwnProperty(j))if(j==="#text")h+=d[j];
                    else if(j==="#cdata")h+="<![CDATA["+d[j]+"]]\>";
                    else if(j.charAt(0)!=="@")h+=g(d[j],j,i+"\t");h+=(h.charAt(h.length-1)==="\n"?i:"")+"</"+c+">"
                }
...
toJson:function(a,b,g,e){
    ...
    if(a==="[]")f+=b?":[]":"[]";
        ...
        i=[];
        for(h in a)if(a.hasOwnProperty(h))i[i.length]=this.toJson(a[h],h,g+d,e);f+=(b?":{":"{")+(i.length>1?c+g+d+i.join(","+
            c+g+d)+c+g:i.join(""))+"}"
